...
de=cal.getTime().toString(); 
System.out.println(de=de.substring(11,19));
de=de.replaceAll(":","");

WebDriverWaits.ClickOn(Overviewtab);
WebDriverWaits.ClickOn(AddGenericService);
WebDriverWaits.SendKeys(ProductDesc, de+"This is Product Description");
WebDriverWaits.ClickOn(ProrataDate);
WebDriverWaits.ClickOn(Todaydate);
WebDriverWaits.SendKeys(Quantity, "1");
WebDriverWaits.SendKeys(RollupDesc, "This is testing of Rollup Description");
