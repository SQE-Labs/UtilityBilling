...
public class CreateServicePage extends BasePage {
	...
	public void enterProductDescription(String productText) {
		...
		sendKeys_withClear(productDescription, "Name" + randomGenerator.requiredCharacters(4));
	}
	...
	public void newRetailElectricitySevice(String recordIdText, String selectPlanText, String MeterConfigurationText,
			String readingTypeText) throws InterruptedException {
	...
	public void addProvisioning(String ServiceType, String MarketType, String TransferType)
	...
	public void addTransferDetails(String servicType, String marketTYpe, String transferType)
			throws InterruptedException {
		// 1. Customer is already created using Customer flow.
		// 2. Adding electricity service to a customer.
		// 3. Overview > Electricity
	...
	public void waterSevice(String recordIdText, String selectPlanText, String MeterConfigurationText,
			String readingTypeText) throws InterruptedException {
		// 1. Customer is already created using Customer flow.
	...
	public void gasService(String recordIdText, String selectPlanText, String MeterConfigurationText,
			String readingTypeText) throws InterruptedException {
		// 1. Customer is already created using Customer flow.
		// 2. Adding water service to a customer.
		// 3. Overview > Water
	...
	public void genericService(String recordIdText, String productText, String prorataText, String dateText,
			String quantityText, String notesText, String chargeText, String rollupText, String typeText,
			String unitText, String rateText) throws InterruptedException {
		as = new Assertions();
		clickOnSearchBtn(recordIdText);
		Thread.sleep(2000);
		clickGenericService();
	...
	public void editGenericService(String productText, String quantityText, String notesText, String rollupText,
			String typeText, String unitText, String validateText) throws InterruptedException {
		as = new Assertions();
		clickServices();
		clickEditService();
		enterProductDescription(productText);
