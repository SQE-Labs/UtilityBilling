...
//Services
	...
	public void enterGeneralDetails(String TittleText, String firstNameText, String lastnameText,
		String phoneNumberText, String FaxText, String emailText, String billingEmailText, String reminderText) {
	...
	public void enterPhysicalAddressDetails(String addressOneText, String addressTwoText, String cityText,
		String stateText, String zipCodeText, String countryText) {
		sendKeys_custom(addressOneField, addressOneText, "Address1");
		sendKeys_custom(addressTwoField, addressTwoText, "Address2");
		sendKeys_custom(cityField, cityText, "City");
		sendKeys_custom(stateField, stateText, "State");
	...
	public void enterBillingAddressDetails(String addressOneText, String addressTwoText, String cityText,
	String stateText, String zipCodeText, String countryText) {
	...
	public void enterAuthenticationDetails(String AccountNameFieldText, String AuthenticationTypeDropDownText,
		String AuthenticationNoFieldText, String DOBFieldText, String RefereeFieldText,
		String ContactNumberRefereeText, String RefereerelationshiptenantText) {
		sendKeys_custom(AccountNameField, AccountNameFieldText, "Account Name");
		selectDropDownByVisibleText_custom(AuthenticationTypeDropDown, AuthenticationTypeDropDownText,
				"Authentication Type");
		...
		sendKeys_custom(RefereerelationshiptenantField, RefereerelationshiptenantText,
				"Referee relationship to tenant");

	}

	public void enterBankingDetails(String BankAccountNameFieldText, String BankAccountTypeText,
		String BankAccountNoFieldText, String BankRoutefieldText, String BankNameText) {
	...
	public void selectPlanDropdownField(String PlanText) {
		selectDropDownByVisibleText_custom(planDropdownField, PlanText);
	}
	...
	public String createCustomer(String category, String companyName, String firstName, String lastName,
			String phoneNumber, String email, String billingEmail, String addressOne, String addressTwo, String city,
			String zipCode, String country, String plan) throws InterruptedException {
	...
	public String createCustomer(String CustomerType, String category, String companyName, String Tradename,
			String Tittle, String firstName, String lastName, String phoneNumber, String Fax, String email,
			String billingEmail, String reminder, String addressOne, String addressTwo, String city, String state,
			String ZipCode1, String AddressCompany, String Address1, String Address2, String City, String State,
			String ZipCode, String Country, String AccountName, String AuthenticationType, String AuthenticationNo,
			String DOB, String Refrence, String Contactno, String RefreeRelationship, String BankAccountName,
			String BankAccountType, String BankAccountNo, String BankRoute, String BankName, String a, String b,
		...
		enterAuthenticationDetails(AccountName, AuthenticationType, AuthenticationNo, DOB, Refrence, Contactno,
				RefreeRelationship);
