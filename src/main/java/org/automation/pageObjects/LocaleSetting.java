...
public class LocaleSetting extends BasePage {
	...
	public void clickLocalesetting() {
		ActionEngine.clickBtn_custom(localeSubTab);
	    }

	public void selectCurrencySymbol(String currencySymbolText) {
//		WebdriverWaits.waitForElementVisible(currencySymbol, 1);
		ActionEngine.selectDropDownByVisibleText_custom(currencySymbol, currencySymbolText,"Type of Currency");
	      } 
	
	public void selectDecimalPoints(String decimalPointsText) {
		WebdriverWaits.waitForElementVisible(decimalPoints, 1);
		ActionEngine.selectDropDownByVisibleText_custom(decimalPoints, decimalPointsText,"Type of decimal points");
	      } 
	...
	public void selectThousandsSeparator(String thousandsSeparatorText) {
		...
		ActionEngine.selectDropDownByVisibleText_custom(thousandsSeparator, thousandsSeparatorText,"Types of thousandsSeparator");
	      } 
	
	public void selectDecimalSymbol(String decimalSymbolText) {
		WebdriverWaits.waitForElementVisible(decimalPoints, 1);
		ActionEngine.selectDropDownByVisibleText_custom(decimalPoints, decimalSymbolText,"Type of decimal symbol");
	      } 
	public void selectDateFormat(String dateFormatText) {
		WebdriverWaits.waitForElementVisible(dateFormat, 1);
		ActionEngine.selectDropDownByVisibleText_custom(dateFormat, dateFormatText,"Select Date Format");
	      } 
	
	public void selectTimeFormat(String timeFormatText) {
		WebdriverWaits.waitForElementVisible(timeFormat, 1);
		ActionEngine.selectDropDownByVisibleText_custom(timeFormat, timeFormatText,"Select time Format");
	      }
	
	public void enterDecimalSymbol(String userNameText) {
		ActionEngine.sendKeys_withClear(decimalSymbol, userNameText);
	    } 
