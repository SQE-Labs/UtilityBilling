...
public class PaymentsPage extends BasePage
{
	...
	//remove static
	 ...
	 public void selectPaymentMethodOption(String paymentMethodTypeText)
		{
			...
			ActionEngine.selectDropDownByVisibleText_custom(paymentMethoddropdownfield, paymentMethodTypeText," Payment Method" );
		}
	 ...
	 public void PaymentsFromCreditCard(String transactionTypeText,String paymentMethodTypeText,String receiptEmailText,String amountText,String commentText) throws InterruptedException
	 {
		 as= new Assertions();
