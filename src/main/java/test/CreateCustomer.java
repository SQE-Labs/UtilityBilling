...
public class CreateCustomer extends BaseTest {
    ...
    @Test(priority = 20,enabled = true, description = "Create Commercial Customer")
    ...
    @Test(priority = 21,enabled = true, description = "Create Business Customer")
    ...
    @Test(priority =22,enabled = true, description = "Create Residential Customer")
