...
public class ElecPlanManagementTest extends BaseTest {
    ...
    public void editAllocationBucket() throws InterruptedException {
        editAllocation.edit_Allocation("Commercial Plan", "Add New Bucket568", "50");
    }
    ...
    public void addAllocationBucket() throws InterruptedException {
        addAllocation.add_Allocation("Commercial Plan", "Electric Discount", "None", "Add New Bucket568", "Electricity Charges", "Usage Flat Rate", "Kilowatt (KW)", "10");
    }
