...
public class ElecPlanManagementTest extends BaseTest {
    ...
    @Test(priority = 10,enabled = true, description = "Create Plan")
    ...
    @Test(priority = 11,enabled = true, description = "Create Plan")
    public void createPlan() throws InterruptedException {
        plan.createPlan("testing002", "Retail Electricity", "Adam Johhns", "Usage charge", "None", "Water Charges", allocationBucket, "Usage Flat Rate", "Kiloliter (kL)", "65");
    }

    @Test(priority = 12,enabled = true, description = "Add Tarif")
    public void addTarif() throws InterruptedException {
        tarifPlan.addTarif("Usage charge", "None", "Electricity Charges", allocationBucket, "Network Usage Flat Rate", "Kilowatt (KW)", "65");
    }

    @Test(priority = 13, enabled = true,description = "Add Monthly Tarif")
    public void addMonthlyTarif() throws InterruptedException {
        monthlyTarif.addMonthlyTarif("monthly administration fee", "None", "Electricity Charges", allocationBucket, "Usage Tiered Monthly", "Kilowatt (kW)", "No Tax", "10", "100", "1000");
    }

    @Test(priority = 14, enabled = true, description = "Add Tarif Connection Fee")
    public void addTarifConnectionFee() throws InterruptedException {
        connectionFee.addTarifConnection("Connection Fee", "None", "Account Level Charges", allocationBucket, "Access Fee Per Day", "Month", "60", "No Tax");
    }

    @Test(priority = 15, enabled = true, description = "Create Commercial Plan")
    public void addCommercialPlan() throws InterruptedException {
        commercialPlan.createCommercialPlan("testing002", "Retail Electricity", "Adams Johhons", "Usage commerical", "None", "Electricity Charges",  allocationBucket , "Usage Peak", "Kilowatt (kW)", "65");
    }

    @Test(priority = 16, enabled = true, description = "Add Monthly Plan")
    public void addMonthlyPlan() throws InterruptedException {
        monthlyPlan.addMonthlyPlan("monthly administration fee", "None", "Electricity Charges", allocationBucket, "Usage Tiered Monthly", "Kilowatt (kW)", "No Tax", "20", "100", "1000");
    }

    @Test(priority = 17, enabled = true, description = "Edit Allocation Bucket in Plans Tariff")
    ...
    @Test(priority = 18,enabled = true, description = "Add Allocation Bucket in Plans Tariff")
    ...
    @Test(priority = 19,enabled = true, description = "Autogenrate_Four_plans")
